<%@ page title="" language="C#" masterpagefile="~/MPAdmon.master" autoeventwireup="true" inherits="Pages_Administrador_Historialticket, App_Web_e5nmtpw2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function Comentario(id) {
            window.radopen("../../Pages/Usuario/comentario.aspx?id=" + id + "&tipo=0", "rwcomentarios");
        }
            ...
            <ContentTemplate>
                <table class="w-100">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <telerik:RadComboBox ID="rcbproyecto" runat="server" AutoPostBack="true" Width="300px" DataTextField="descripcion" DataValueField="id" EmptyMessage="--Seleccione" Filter="Contains" OnSelectedIndexChanged="rcbproyecto_SelectedIndexChanged" Skin="Bootstrap">
                            </telerik:RadComboBox>
                        </td>
                        <td>
